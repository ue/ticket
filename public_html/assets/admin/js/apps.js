...
var ticketApp = function(){
    ...
    return {
        ...
        init: function () {
            ticketApp.handleIE();
            ticketApp.handleCheckCookie();
            ticketApp.handleSound();
            ticketApp.handleBackToTop();
            ticketApp.handleSidebarNavigation();
            ticketApp.handleSidebarScroll();
            ticketApp.handleSidebarResponsive();
            ticketApp.handleNavbarScroll();
            ticketApp.handlePanelScroll();
            ticketApp.handleTypehead();
            ticketApp.handleFullscreen();
            ticketApp.handleTooltip();
            ticketApp.handlePopover();
            ticketApp.handlePanelToolAction();
            ticketApp.handleSparkline();
            ticketApp.handleClearCookie();
            ticketApp.handleBoxModal();
            ticketApp.initCopyrightYear();
        },
